...
public class AmbushSlashAbility implements Ability {
    ...
    private double stage1Damage = 6.0D;
    private double stage2Damage = 9.0D;
    private int markDurationTicks = 100;
    private int natureBurnDurationTicks = 80;
    private int natureBurnAmplifier = 0;
    private double natureBurnSpreadRadius = 3.0D;
    private double teleportOffset = 1.5D;
    private double blastRange = 30.0D;
    private double blastCheckRadius = 1.5D;
